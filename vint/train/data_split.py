...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data-dir", "-i", help="Directory containing the data", required=False, default=os.path.expanduser("~/Desktop/Yamin335/vint/thi_data")
    )
    parser.add_argument(
        "--dataset-name", "-d", help="Name of the dataset", required=False, default="thi_data"
    )
    parser.add_argument(
